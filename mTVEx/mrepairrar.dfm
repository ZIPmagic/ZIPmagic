object RepairRar: TRepairRar
  Left = 255
  Top = 18
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = 'MimarSinan Rar Repair'
  ClientHeight = 195
  ClientWidth = 399
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    AutoSize = False
    Caption = 
      'You may repair a rar file that has become damaged. The best of t' +
      'wo available repair methods will be selected automatically.'
    WordWrap = True
  end
  ...
  object Label4: TLabel
    ...
    Width = 119
    Height = 13
    Caption = 'Save &repaired rar file as:'
    FocusControl = Saved
  end
  object Label2: TLabel
    ...
    AutoSize = False
    Caption = 
      'For higher success when repairing rar files, please make sure th' +
      'at you create rar files with recovery information, or use the "P' +

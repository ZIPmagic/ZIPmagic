...
uses
  ...
  MimarSinan.Codex in 'MimarSinan.Codex.pas';
...
[STAThread]
begin
  StartSplash('MimarSinan Codex Test Skin for the Microsoft .NET Platform', ParamStr(0));
  CheckCodexAssociations;
  Application.Initialize;
  Application.Title := 'MimarSinan Codex Test Skin for the Microsoft .NET Platform';
